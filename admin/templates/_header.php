...
<?php } ?>
<?php } ?>
<script>document.addEventListener("DOMContentLoaded",function(){var e=document.querySelector(".header__logo_img");e&&(e.style.width="150px",e.style.maxWidth="150px",e.style.height="auto",//e.style.transform="scale(0.25)",//e.style.transformOrigin="left top")});</script>
