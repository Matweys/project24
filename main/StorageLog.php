...
class StorageLog
{
    ...
    public static function move_file(\PDO $db, array $user, array $storage, array $files_to_move, ?array $destination_folder)
    {
        Log::message(
            db: $db,
            message: Yaml::dump([
                'payload' => array_map(function ($v) use ($destination_folder, $storage) {
                    return array_filter([
