...
include '_header.php';
?>
<div class="file-form-pdf-viewer">
	<iframe style="border: 0;" class="file-form-pdf-viewer-iframe" src="<?=$config['static_url']?>/pdfjs/web/viewer.html?file=<?=rtrim($config['upload']['url'], '/') . '/' . $storage['uid'] . '/' . $data['file']?>#pagemode=none"></iframe>
	<div class="file-form-pdf-viewer-sidebar">
