...
<?php } ?>
<?php if ($full_permission) { ?>
<a class="btn btn-secondary" href="<?php echo $config['base_url'].'/storage/reindex/'.$storage['uid'].'/?'.http_build_query(['url' => $return_url]); ?>" style="background-color:transparent;border:none;margin:0 .125rem;padding:.125rem .25rem;" title="Обновить индексы поиска"><img src="<?php echo $config['static_url']; ?>/assets/img/icon_search.svg"></a>
<?php } ?>
